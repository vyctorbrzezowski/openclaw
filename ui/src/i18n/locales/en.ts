...
export const en: TranslationMap = {
  ...
  sessionsView: {
    ...
    automationNamed: "{name} · automation",
    incognito: "Incognito session",
    cloudWorkerPlacement: "Cloud workspace · {state}",
    cloudWorkerReclaimed: "Cloud workspace · synced",
  ...
  attention: {
    ...
    automationFailedTitle: '"{name}" failed',
    automationFailingRepeatedlyNamed: "{name} · failing repeatedly",
    automationMissedScheduleNamed: "{name} · missed schedule",
    providerAuthExpired: "{providers} · auth expired",
    failingRepeatedly: "Failing repeatedly",
    missedSchedule: "Missed schedule",
    authExpired: "Authentication expired",
    reconnect: "Reconnect",
    authReconnected: "{provider} reconnected",
    automationRecovered: '"{name}" recovered',
    approvals: "Approvals",
    ...
    systemStatusAria: "System status: {issues}, {blocking} blocking",
    needsAttention: "Needs attention",
    recent: "Recent",
