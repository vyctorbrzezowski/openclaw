  ...
  chat: {
    ...
    toolCards: {
      ...
      group: {
        ...
        commandsMany: "ran commands",
        readsOne: "read a file",
        readsMany: "read files",
        editsOne: "edited a file",
        editsMany: "edited files",
        writesOne: "created a file",
        writesMany: "created files",
        deletesOne: "deleted a file",
        deletesMany: "deleted files",
        searchesOne: "searched the web",
        searchesMany: "searched the web",
        fileSearchesOne: "searched files",
        fileSearchesMany: "searched files",
        fetchesOne: "read a web page",
        fetchesMany: "read web pages",
        otherOne: "used a tool",
        otherMany: "used tools",
        worked: "Worked",
        thinking: "Thinking",
        runningCommand: "Running {command}",
