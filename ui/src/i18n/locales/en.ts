...
export const en: TranslationMap & {
  ...
  usage: {
    dimensions: {
      ...
      messageHint: "{count} message",
      messagesHint: "{count} messages",
      empty: {
        model: "No model usage in this range.",
        provider: "No provider usage in this range.",
        agent: "No agent usage in this range.",
        channel: "No channel usage in this range.",
        tool: "No tool calls in this range.",
        day: "No daily usage in this range.",
      },
    },

    summary: {
      tokenStats: "Token usage",
      perActiveDay: "{value} per active day",
      activeDaysHint: "Average over {count} days with reported token usage in the selected scope.",
      cachedInput: "Cached input",
      promptShare: "{percent}% of prompt tokens",
      uncachedInput: "Uncached input",
      cacheWrites: "{value} cache writes",
      uncachedInputHint: "Input tokens counted separately from cache reads and cache writes.",
      reportedOutput: "Reported output tokens",
      outputHint:
        "Output tokens reported by the usage record. Separate reasoning-token accounting is unavailable in this summary.",
      cacheSavings: "Cache savings",
      unavailable: "Unavailable",
      cacheSavingsHint:
        "Recorded usage does not include a reliable cost comparison for serving cached requests without caching.",
      efficiency: "Efficiency",
      errorsOfMessages: "{errors} errors · {messages} messages",
      averageDuration: "Average duration: {value}.",
    },
    hero: {
      recordedCost: "Recorded usage cost",
      recordedTokens: "Tokens in the selected scope",
      dailyCost: "Daily cost",
      dailyTokens: "Daily tokens",
      unattributed: "Unattributed",
      partialAttribution:
        "Some daily usage has no provider attribution. Unattributed includes any usage outside the available session records.",
      partialToday: "Today is still in progress. Dashed lines show partial usage, not a forecast.",
      more: "+{count} more",
      analysis: "Token composition and cost windows",
      savingsUnavailable: "Savings unavailable",
    },

    operations: {
      title: "Operations",
      activity: "Activity",
      reliabilityCost: "Reliability & cost",
      activeTime: "{value} recorded active time",
      latency: "Response latency",
      latencyRange: "p95 {p95} · {min}–{max} · {count}\u00a0samples",
      latencyHint: "Response duration from recorded usage samples. Missing samples are excluded.",
      definitions: "Metric definitions",
    },
    analytics: {
      componentTotals:
        "Component totals exceed the reported total for some days. The chart shows the component sum.",
      dailyUsage: "Daily usage",
      chartMetric: "Chart metric",
      noDailyData: "No daily usage data available.",
      daySelectionHint: "Select a day to filter. Shift selects a range.",
    },
    common: {
      emptyValue: "—",
      unknown: "unknown",
    ...
    scope: {
      ...
      familyIncluded: "Session instances in historical lineage: {count}.",
    },
    filters: {
      moreActions: "More actions",
      title: "Filters",
      ...
      timeZoneLocal: "Local",
      timeZoneUtc: "UTC",
      pin: "Keep filters visible while scrolling",
      pinned: "Unpin filters",
    ...
    query: {
      ...
      tip: "Use filters or select days in the chart. Examples: key:agent:main:cron* model:gpt-4o has:errors minTokens:2000",
    },
    export: {
      label: "Export",
    ...
    empty: {
      ...
      subtitle: "Choose another date range or select Refresh to check for new usage data.",
    },
    daily: {
      display: "Daily usage display",
      total: "Total",
      byType: "By type",
    ...
    overview: {
      tokensHint: "Total tokens in the selected scope.",
      topModels: "Top models",
      topProviders: "Top providers",
      noProviderData: "No provider data",
      costHint:
        "Recorded session costs, including configured model estimates. Some cost data may be missing.",
      missingCost: "Cost data is missing for some entries.",
      title: "Usage Overview",
      messages: "Messages",
    ...
    sessions: {
      columns: "Columns",
      compare: "Compare {count} sessions",
      compareHint: "Select a session to inspect its details.",
      inspectSession: "Inspect this session",
      msgsTitle: "Msgs",
      channelAgent: "Channel / Agent",
      providerModel: "Provider / Model",
      selectSession: "Select {name}",
      openHint: "Click to open · Shift to select a range",
      title: "Sessions",
      shown: "{count} shown",
      total: "{count} total",
      avg: "avg",
    ...
    details: {
      ...
      lastActivity: "Last activity",
      noUsageData: "Session summary is unavailable.",
      ...
      awaitingGateway: "Waiting for the gateway. Showing previous data.",
      ...
      samples: "samples",
      sampleRange: "Samples {start}–{end} of {total}",
