...
const environmentByColor = new Map<ControlUiEnvironment["color"], ControlUiEnvironment>(
...
function installTuner() {
  ...
  const fullHeaderSurfaceInput = panel.querySelector<HTMLInputElement>(
    "[data-full-header-surface]",
  )!;
  ...
  environmentSelect.addEventListener("change", () => {
    state.environmentColor = (environmentSelect.value as ControlUiEnvironment["color"]) || null;
    queueApply();
  });
