...
export const icons = {
  ...
  cloudCog: strokeIcon(svg` <path d="m10.852 19.772-.383.924" />
  ...
  cloudCheck: strokeIcon(svg` <path d="m17 15-5.5 5.5L9 18" />
    <path d="M5.516 16.07A7 7 0 1 1 15.71 8h1.79a4.5 4.5 0 0 1 3.501 7.327" />`),
  cloudSync: strokeIcon(svg` <path d="m17 18-1.535 1.605a5 5 0 0 1-8-1.5" />
    <path d="M17 22v-4h-4" />
    <path d="M20.996 15.251A4.5 4.5 0 0 0 17.495 8h-1.79a7 7 0 1 0-12.709 5.607" />
    <path d="M7 10v4h4" />
    <path d="m7 14 1.535-1.605a5 5 0 0 1 8 1.5" />`),
  cloudAlert: strokeIcon(svg` <path d="M12 12v4" />
    <path d="M12 20h.01" />
    <path d="M8.128 16.949A7 7 0 1 1 15.71 8h1.79a1 1 0 0 1 0 9h-1.642" />`),
  cloudOff:
    strokeIcon(svg` <path d="M10.94 5.274A7 7 0 0 1 15.71 10h1.79a4.5 4.5 0 0 1 4.222 6.057" />
  ...
  listFilter: strokeIcon(svg` <path d="M3 6h18" />
    <path d="M7 12h10" />
    <path d="M10 18h4" />`),
  slidersHorizontal: strokeIcon(svg` <line x1="21" x2="14" y1="4" y2="4" />
