...
When `gateway.publicOrigin` exposes an enabled Control UI, chat failure notifications also include an **Open automation** URL button. Webhook payloads remain unchanged.
